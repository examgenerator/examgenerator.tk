function generate() {
    ...
    printwindow.document.write("<!DOCTYPE html><html><head><title>Generated exam (examgenerator.tk)</title><style>body, footer{font:15px Arial;} td{padding-right: 200px;}</style></head><body><table>");
    for (var x in terms) 
    {
